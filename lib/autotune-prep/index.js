...
function generate (inputs) {
  ...
  if (inputs.tune_insulin_curve) {
    if (opts.profile.curve === 'bilinear') {
      ...
      } else if (! opts.profile.useCustomPeakTime === true && opts.profile.curve === "45peak") {
        opts.profile.insulinPeakTime = 45;
      } else if (! opts.profile.useCustomPeakTime === true && opts.profile.curve === "40peak") {
        opts.profile.insulinPeakTime = 40;
